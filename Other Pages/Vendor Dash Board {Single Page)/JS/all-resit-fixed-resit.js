...
// let vendorDashboardSectionBlur= document.querySelector(".vendor-dashboard")
...
const showEditSection = (hiddenSection, mainSection) => {
    ...
    // vendorDashboardSectionBlur.style.filter="blur(0.4vw)";
...
const hideEditSection = (hiddenSection, mainSection) => {
    ...
    // vendorDashboardSectionBlur.style.filter="blur(0vw)";
...
const showAllLoadingSection = (title) => {
    ...
    // fixedResitSectionBlur.style.filter="blur(0.4vw)";
    let fixedResitSectionBlur =  document.querySelectorAll(".fixed-resit-section")
